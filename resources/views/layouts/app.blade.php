                            ...
                            @if (Auth::user()->role === 'admin')
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="adminDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.deposits.create') }}">Create Deposit</a>
                                        <a class="dropdown-item" href="{{ route('admin.loans.create') }}">Create Loan</a>
                                        <a class="dropdown-item" href="{{ route('admin.loan-payments.create') }}">Create Loan Payment</a>
                                    </div>
                                </li>
                            @endif
                            <li class="nav-item dropdown">
